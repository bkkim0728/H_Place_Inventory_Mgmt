...
| 본사 대시보드 | 전체 관리자: 운영 중인 모든 지점을 한 화면에. 기간(최근 7일·30일·이번 달·지난달)별 전체 총매출·시술 매출·제품 판매·재료비율과 이전 기간 대비 증감, 재고 금액·재고 경고·오늘 근무·시술 매출 입력률, 일별 총매출 지점별 누적 막대(마우스 올리면 지점별 금액), 지점별 성과 비교표(매출 비중·객단가·재료비율·재고·근무·입력률, 지점명을 누르면 그 지점 매장 레포트로), 전 지점 인기 제품, 확인이 필요한 항목, 엑셀·인쇄 |
